...
vc_map(
 array(
    "name" => esc_html__( "Feature Block", "iasion-themenow" ),
    "base" => "iasion_feature",
    ...
    "params" => array(
           array(
            "type" => "textfield",
            "heading" => __("Feature Title","iasion-themenow"),
            "param_name" => "title",
            "description" => __( "Give Feature Title ", "iasion-themenow"),
           ),
            
           
            array(
            "type" => "textarea",
            "heading" => esc_html__("Feature Description","iasion-themenow"),
            "param_name" => "desc",
