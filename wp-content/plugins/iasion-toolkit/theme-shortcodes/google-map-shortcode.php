...
function iasion_google_map_shortcode($atts, $content = null) {
    ...
    return $iasion_google_map_markup;
    
}
add_shortcode('iasion_google_map', 'iasion_google_map_shortcode');